  ...
  theme: {
    ...
    extend: {
      colors: {
        ...
        din: {
          bg: "oklch(var(--din-bg))",
          surface: "oklch(var(--din-surface))",
          "surface-alt": "oklch(var(--din-surface-alt))",
          border: "oklch(var(--din-border))",
          text: "oklch(var(--din-text))",
          muted: "oklch(var(--din-muted))",
          teal: "oklch(var(--din-teal))",
          orange: "oklch(var(--din-orange))",
